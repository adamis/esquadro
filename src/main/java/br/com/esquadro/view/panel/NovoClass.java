...
public class NovoClass extends JInternalFrame {
	 ...
	 * Create the panel.
	 */
	public NovoClass(ConsoleLog consoleLog) {
		...
		nomeComponent.setBounds(10, 117, 481, 20);
		getContentPane().add(nomeComponent);
		nomeComponent.setColumns(10);

		JButton btnGerarProjeto = new JButton("     Gerar Class");
		...
		btnGerarProjeto.setBounds(182, 359, 141, 36);
		...
		ckSpecOff.setBounds(22, 174, 97, 23);
		...
		txtApp.setBounds(127, 201, 334, 20);
		...
		panel.setBounds(10, 153, 481, 111);
		...
		panel_1.setBounds(10, 275, 481, 73);
...
//		System.err.println("INICIO");
		...
		ProcessBuilder pb = new ProcessBuilder("cmd.exe", "/c",
				"cd " + inputWorkspace.getText() + "& ng generate class " + nomeComponent.getText());
		...
		consoleLog.setText("Criando nova Class: " + nomeComponent.getText());
...
//			System.out.println(f.getAbsolutePath());
	...
	private String finalizaComand() {
		lblComando.setText(
				"<html><div>" + "ng generate class " + nomeComponent.getText() + " " + getPrefix() + "</div></html>");
